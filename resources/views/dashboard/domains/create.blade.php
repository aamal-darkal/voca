        ...
        <div class="row">
            ...
            <table style="visibility: collapse;">
                <tr class="table-row" id="template">
                    <td>
                        <input type="text" name="titles[]" class="form-control min-w-100px" maxlength="100" required>
                    </td>
                    <td>
                        <input type="text" name="descriptions[]" class="form-control min-w-300px" maxlength="255"
                            required>
                    </td>
                    <td>
                    ...
                    <td>
                        <button type="button" class="pull-right btn btn-outline-mine" onclick="delete_row(this)"
                            title="Remove this translation">-</button>
                    </td>
                </tr>
            </table>
            {{-- ========================== end template  ======================================= --}}
            <form action="{{ route('domains.store') }}" method="post" class="col-md-10  ">
                ...
                <div class="control-group">
                    ...
                    <input type="number" name="order" value="{{ old('order') }}" placeholder="Order" min=1
                        class="form-control my-2 w-100px">
                            ...
                            <tr>
                                <td class="control-group">
                                    <input type="text" name="title" id="title" value="{{ old('title') }}"
                                        placeholder="Domain title" class="form-control my-2 min-w-100px" maxlength="100"
                                        required>
                                    <div class="text-danger">
                                        @error('title')
                                            {{ $message }}
                                ...
                                <td class="control-group">
                                    <input type="text" name="description" value="{{ old('description') }}"
                                        placeholder="Domain description" class="form-control my-2 min-w-300px"
                                ...
                                <td class="col-md-2 control-group">
                                    <input type="text" value="arabic" class="form-control my-2 min-w-150px" readonly>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            @if ($titles)
                                @for ($i = 0; $i < count($oldlanguages); $i++)
                                    <tr class="table-row">
                                        ...
                                        <td>
                                            <select name="languages[]" id="language" class="form-select my-2 min-w-150px"
                                                required>
                                                <option value="" hidden> Lang</option>
                                                @foreach ($languages as $language)
